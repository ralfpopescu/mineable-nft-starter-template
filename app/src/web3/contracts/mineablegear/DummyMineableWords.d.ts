...
interface DummyMineableWordsInterface extends ethers.utils.Interface {
  functions: {
...
export class DummyMineableWords extends BaseContract {
  ...
  interface: DummyMineableWordsInterface;
