...
interface OldMGearInterface extends ethers.utils.Interface {
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "getApproved(uint256)": FunctionFragment;
    "getMGearName(uint256)": FunctionFragment;
...
export class OldMGear extends BaseContract {
  ...
  getMGearName(mgear: BigNumberish, overrides?: CallOverrides): Promise<string>;
